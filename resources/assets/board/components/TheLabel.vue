<template>
    <v-sheet class="d-flex align-center mb-2">
        <div v-show="!isEditable" @click="makeEditable" class="me-auto font-weight-bold" :class="'text-' + modelValue.color">{{ modelValue.title }}</div>
        <input placeholder="Add a label"
               class="the-label-title me-auto font-weight-bold"
